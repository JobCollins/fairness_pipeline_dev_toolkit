...
if __name__ == "__main__":
    ...
    print(
        f"Demographic Parity Difference: {dp_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )
    ...
    print(
        f"Equalized Odds Difference: {eo_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )
    ...
    print(
        f"MAE Parity Difference: {mae_parity_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )

    start = time.time()
    dp_inter_result = fa.demographic_parity_difference(
        y_pred, sensitive=None, intersectional=True, attrs_df=attrs
    )
    end = time.time()
    print(
        f"Demographic Parity Difference (Intersectional): {dp_inter_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )
    ...
    print(
        f"Equalized Odds Difference (Intersectional): {eo_inter_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )

    start = time.time()
    mae_parity_result = fa.mae_parity_difference(
        y_reg, y_hat, sensitive=None, intersectional=True, attrs_df=attrs
    )
    end = time.time()
    print(
        f"MAE Parity Difference (Intersectional): {mae_parity_result.value:.4f}, Time taken: {end - start:.2f} seconds"
    )
